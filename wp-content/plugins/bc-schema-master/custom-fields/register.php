...
function angular_app_load(){
    ...
    if ( (isset($post->post_type) ? $post->post_type : null) == 'bc_schemas') {
...
?>
    <form method="post" target="_blank" action="https://search.google.com/test/rich-results">
        <textarea name="code_snippet" class="hide" style="display: none;"></textarea>
    </form>
    <form id="google-form" method="post" target="_blank" action="https://search.google.com/structured-data/testing-tool">
        <textarea name="code" class="hide" style="display: none;"></textarea>
    </form>
...
function bc_schema_change_title($data){
    ...
    $data['post_title'] = json_decode(stripslashes($_POST['schema_type']))->type2->name;
    return $data;
}*/
