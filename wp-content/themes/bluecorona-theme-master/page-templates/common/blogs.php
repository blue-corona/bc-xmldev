            ...
            <div class="col-lg-9 offset-lg-3 m-auto text-center">
                ...
                <div class="swiper-container bc_affiliation_swiper bc_blog_swiper container  swiper-container-initialized swiper-container-horizontal">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide swiper-slide-duplicate">
                            <div class="text-center"><img class="img-fluid" alt="blog-image-2" src="<?php echo get_template_directory_uri();?>/img/blog_img_03.png">
                            <h3 class="text-left py-2 text-uppercase bc_text_medium bc_text_18">space heater safety tips...</h3>
                            </div>
                        </div>
                        <div class="swiper-slide swiper-slide-duplicate">
                            <div class="text-center"><img class="img-fluid" alt="blog-image-3" src="<?php echo get_template_directory_uri();?>/img/blog_img_04.png">
                            <h3 class="text-left py-2 text-uppercase bc_text_medium bc_text_18">reasons to use a programmable thermostat...</h3>
                            </div>
                        </div>
                        <div class="swiper-slide swiper-slide-duplicate swiper-slide-prev">
                            <div class="text-center"><img alt="blog-image-4" src="<?php echo get_template_directory_uri();?>/img/blog_img_01.png">
                            <h3 class="text-left py-2 text-uppercase bc_text_medium bc_text_18">winterizing your hvac system...</h3>
                            </div>
                        </div>
                        <div class="swiper-slide swiper-slide-active">
                            <div class="text-center"><img alt="blog-image-5" src="<?php echo get_template_directory_uri();?>/img/blog_img_02.png">
                                 <h3 class="text-left py-2 text-uppercase bc_text_medium bc_text_18">space heater safety tips...</h3>
                            </div>
                            </div>
                        </div>
