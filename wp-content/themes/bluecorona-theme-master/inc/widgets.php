	...
	function understrap_widgets_init() {
		...
		register_sidebar(
			array(
				...
				'id'            => 'blogrightside',
				'description'   => __( 'Include Sections you need in blog right sidebar', 'understrap' ),
		...
		register_sidebar(
			array(
				...
				'description'   => __( 'Include Sections you need in Sub Page right sidebar', 'understrap' ),
			)
		);
		...
		register_sidebar(
			array(
				...
				'description'   => __( 'Include Sections you need in single blog right sidebar', 'understrap' ),
			)
		);
