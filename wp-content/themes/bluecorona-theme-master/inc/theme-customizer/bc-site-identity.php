...
function bc_customize_register($wp_customize){
    ...
    $wp_customize->add_setting('bc_theme_options[bc_logo_upload]', array(
        'default'           => 'http://localhost/bluecorona/wp-content/uploads/2019/09/children-flossing-min-1024x680.jpg',
    ...
    $wp_customize->add_setting('bc_theme_options[bc_favicon_upload]', array(
        'default'           => 'http://localhost/bluecorona/wp-content/uploads/2019/10/android-icon-48x48.png',
        'capability'        => 'edit_theme_options',
        'type'           => 'theme_mod',
