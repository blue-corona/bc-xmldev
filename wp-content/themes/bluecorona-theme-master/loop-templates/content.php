...
<?php endif; ?>
	...
	<div class="col-md-8 px-4">
		<article>
		<h3 class="bc_blog_heading_color text-uppercase font-weight-bold"><?php the_title()?></h3>
		<p class="m-0"><strong><?php the_time( 'm/d/y' ); ?></strong></p>
		<p class="m-0">	<?php echo get_the_excerpt();?> ... <br>
		<a class="bc_blog_heading_color no_hover_underline" href="<?php echo get_permalink();?>"><span class="pr-1">READ MORE</span> <em aria-hidden="true" class="fa fa-chevron-circle-right"></em>
			</a>
		</p>
		</article>
	</div>
