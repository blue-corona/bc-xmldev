...
/*Menu Classes*/
    ...
    .bc_nav_container .navbar-nav li:hover a.nav-link { color: <?php echo bc_get_theme_mod('bc_theme_options', 'navigation_bar','top_level_link_hover', '#ffffff');?>; } /* Top level link hover */
