...
a{<?php echo generate_font_settings('a');?>;text-decoration: <?php if(isset($theme_a_configuration['a_text_decoration'][0]) && !empty($theme_a_configuration['a_text_decoration'][0])){ echo $theme_a_configuration['a_text_decoration'][0];}else{ echo 'none'; }?>}
a:hover{<?php echo 'color:'.bc_get_theme_mod('bc_theme_a_configuration', 'a_hover_color','', false).'; background-color:'.bc_get_theme_mod('bc_theme_a_configuration', 'a_hover_background_color','', false).';';?>;text-decoration: <?php if(isset($theme_a_configuration['a_hover_decoration'][0]) && !empty($theme_a_configuration['a_hover_decoration'][0])){ echo $theme_a_configuration['a_hover_decoration'][0];}else{ echo 'none'; }?>}
</style>
<?php
}
