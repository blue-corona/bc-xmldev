<?php 
    ...
    function validate_bc_slider_rotation_time_one($validity, $value){
        ...
        if ( empty( $value ) || ! is_numeric( $value ) ) {
            ...
            $validity->add( 'required', __( 'Not more than 7.' ) );
        }
        return $validity;
    }
    ...
    $wp_customize->add_setting('bc_theme_home_options[image_slider][bc_slider_image_one]', array(
        'default'           => 'http://localhost/bluecorona/wp-content/uploads/2019/10/banner.jpg',
        'capability'        => 'edit_theme_options',
        'type'           => 'option',
    ...
    //  = Auto Rotate Slides =
    //  =============================
    /*$wp_customize->add_setting('bc_theme_home_options[image_slider][bc_auto_rotate_slide_two]', array(
        'default'        => 'enabled',
        'capability'     => 'edit_theme_options',
        'type'           => 'option',
    ));
 
    $wp_customize->add_control('bc_theme_home_options[image_slider][bc_auto_rotate_slide_two]', array(
        'label'      => __('Auto Rotate Slides', 'bc'),
        'section'    => 'bc_site_home_scheme',
        'settings'   => 'bc_theme_home_options[image_slider][bc_auto_rotate_slide_two]',
        'type'       => 'radio',
        'choices'    => array(
            'enabled' => 'Enabled',
            'disabled' => 'Disabled',
    ...
    //  = Slide Rotation Timing       =
    //  =============================
    /*$wp_customize->add_setting('bc_theme_home_options[image_slider][bc_slider_rotation_time_two]', array(
        'default'        => '7',
        'capability'     => 'edit_theme_options',
        'type'           => 'option',
        'validate_callback' => 'validate_bc_slider_rotation_time_one',
    ...
    $wp_customize->add_control('bc_theme_home_options[image_slider][bc_slider_rotation_time_two]', array(
        'label'      => __('Slide Rotation Timing', 'bc'),
        'section'    => 'bc_site_home_scheme',
        'settings'   => 'bc_theme_home_options[image_slider][bc_slider_rotation_time_two]',
        'type'       => 'text',
    ));*/
    ...
    //  = Auto Rotate Slides =
    //  =============================
    /*$wp_customize->add_setting('bc_theme_home_options[image_slider][bc_auto_rotate_slide_three]', array(
        'default'        => 'enabled',
        'capability'     => 'edit_theme_options',
        'type'           => 'option',
    ));
 
    $wp_customize->add_control('bc_theme_home_options[image_slider][bc_auto_rotate_slide_three]', array(
        'label'      => __('Auto Rotate Slides', 'bc'),
        'section'    => 'bc_site_home_scheme',
        'settings'   => 'bc_theme_home_options[image_slider][bc_auto_rotate_slide_three]',
        'type'       => 'radio',
        'choices'    => array(
            'enabled' => 'Enabled',
            'disabled' => 'Disabled',
    ...
    //  = Slide Rotation Timing       =
    //  =============================
    /*$wp_customize->add_setting('bc_theme_home_options[image_slider][bc_slider_rotation_time_three]', array(
        'default'        => '7',
        'capability'     => 'edit_theme_options',
        'type'           => 'option',
        'validate_callback' => 'validate_bc_slider_rotation_time_one',
    ...
    $wp_customize->add_control('bc_theme_home_options[image_slider][bc_slider_rotation_time_three]', array(
        'label'      => __('Slide Rotation Timing', 'bc'),
        'section'    => 'bc_site_home_scheme',
        'settings'   => 'bc_theme_home_options[image_slider][bc_slider_rotation_time_three]',
        'type'       => 'text',
    ));*/
