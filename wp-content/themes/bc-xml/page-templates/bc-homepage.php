...
?>
  ...
  <main role="main">
    ...
    <div class="container-fluid bc_home_section_bg bc_bg_position_bottom p-0 pt-5 pb-5 what_we_do mt-n7" style="background-image:url('<?php echo get_stylesheet_directory_uri(); ?>/img/what-we.png');  ">
