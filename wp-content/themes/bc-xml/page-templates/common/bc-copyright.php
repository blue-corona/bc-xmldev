...
<?php echo bc_get_theme_mod('bc_theme_options', 'footer','copyright_text', '<div class=" container-fluid pb-3 pb-md-0" style="background: #e3e4e9;">
  	<div class="container pb-5 pt-2 py-lg-0 pb-md-0 px-0 text-center">
          ...
          <span class="bc_color_primary bc_sm_text_13 bc_text_heavy bc_text_16 bc_line_height_50 bc_sm_line_height_18 bc_text_normal bc_font_alt_1"> © </span> '.date("Y").' XML FINANCIAL GROUP<span class="d-none d-lg-inline-block px-2">|</span><br class="d-lg-none"></span><span class="d-lg-inline-block bc_color_primary --imp bc_text_16 bc_line_height_50 bc_sm_text_13 bc_sm_line_height_18 bc_text_normal bc_font_alt_1">WEB DESIGN BY <a class="bc_color_primary bc_color_quinary_hover bc_text_normal no_hover_underline text-uppercase" href="https://www.bluecorona.com" target="_blank"><img src="'.get_template_directory_uri().'/img/bc_logo.png">&nbsp;Blue Corona</a></span><span class="d-inline-block bc_color_primary bc_sm_text_13 bc_text_16 bc_line_height_50 bc_sm_line_height_18 bc_text_normal bc_font_alt_1 px-2">|</span><a class="bc_color_primary bc_color_quinary_hover bc_text_normal no_hover_underline bc_text_16 bc_line_height_50 bc_sm_text_13 bc_sm_line_height_18 bc_text_normal bc_font_alt_1 bc_color_secondary_hover text-uppercase" href="#" data-toggle="modal" data-target="#disclaimer">Disclaimer</a>
       </div>
  	</div>
</div>');?>
      ...
      <div class="modal-body p-0 ">
        <div class="">
                    <div class=" col-md-12 col-lg-9 col-sm-12 col-xs-12 offset-lg-2 text-center py-4">
                       <span class="d-block bc_text_36 bc_line_height_36 text-white bc_font_alt_1 text-center bc_text_light text-uppercase">LET’S TALK</span>
