...
<?php echo bc_get_theme_mod('bc_theme_options', 'footer','copyright_text', '<div class=" container-fluid" style="background: #e3e4e9;">
  	<div class="container bc_text_gray_color pb-5 py-4 py-lg-0 pb-md-0 px-0 bc_color_primary text-center text-md-left bc_color_gray bc_text_16 bc_sm_text_13 bc_line_height_50 bc_sm_line_height_18 bc_text_normal bc_font_alt_1">
  		 <span class="bc_text_18 bc_sm_text_13 bc_text_heavy"> © </span> '.date("Y").'  XML FINANCIAL GROUP </span> <span class="d-md-inline-block d-none"> |</span> <span class="d-inline-block bc_color_primary --imp">WEB DESIGN BY
      ...
      <a class="bc_color_primary bc_color_quinary_hover bc_text_normal no_hover_underline bc_text_16 bc_sm_text_13" href="#" data-toggle="modal" data-target="#disclaimer">Disclaimer</a>
  	</div>
</div>');?>
    ...
    <div class="container p-0">
        <div class="row no-gutters">
            <div class="col-md-12 text-center">
                <a href="#" data-toggle="modal" data-target="#myModal_mobile" class="px-3 py-3 no_hover_underline bc_font_default bc_text_24 bc_line_height_26 text-white bc_text_light bc_color_primary_hove bc_color_primary_bg d-block"> LET’S TALK</a>
            </div>
        </div>
    </div>
</div>
