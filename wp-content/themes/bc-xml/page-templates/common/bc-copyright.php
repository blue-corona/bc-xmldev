...
<?php echo bc_get_theme_mod('bc_theme_options', 'footer','copyright_text', '<div class=" container-fluid pb-3 pb-md-0" style="background: #e3e4e9;">
  	<div class="container pb-5 pt-2 py-lg-0 pb-md-0 px-0 text-center text-md-left">
          ...
          <a class="bc_color_primary bc_color_quinary_hover bc_text_normal no_hover_underline bc_text_16 bc_line_height_50 bc_sm_text_13 bc_sm_line_height_18 bc_text_normal bc_font_alt_1 bc_color_secondary_hover" href="#" data-toggle="modal" data-target="#disclaimer">Disclaimer</a>
       </div>
  	</div>
</div>');?>
