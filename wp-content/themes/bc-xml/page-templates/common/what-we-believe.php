              ...
              <div class="modal-dialog modal-xl" id="vimeoWrap" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body video-container">
                    <div style="padding:56.25% 0 0 0;position:relative;"><iframe id="homepagevid" src="https://player.vimeo.com/video/429647404" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe></div>
                    <script src="https://player.vimeo.com/api/player.js"></script>
                    <script>
                      var videoSrc = jQuery("#homepagevid").attr("src");

                      jQuery('#exampleModal').on('show.bs.modal', function () { // on opening the modal
                        // set the video to autostart
                        jQuery("#homepagevid").attr("src", videoSrc+"?autoplay=1");
                      });

                      jQuery("#exampleModal").on('hidden.bs.modal', function (e) { // on closing the modal
                        // stop the video
                        jQuery("#homepagevid").attr("src", null);
                      });
                    </script>
                  </div>
