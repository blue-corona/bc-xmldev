<div class="container-fluid px-0 m-0 <?php if(is_home() || is_front_page()) { echo 'bc_color_light_bg'; } ?>">
    <div class="graphic_lines pb-5">
      <div class="container">
          <div class="row no-gutters py-lg-5">
              <div class="col-lg-10 px-lg-4 offset-lg-1 text-center  py-lg-5">
                  <h2 class="position-relative bc_text_36 bc_line_height_50 mt-5 bc_font_default bc_text_thin text-white bottom_line1 d-block px-xl-0 px-lg-5 mx-xl-4 mx-lg-5 bc_sm_text_32 bc_sm_line_height_32 pt-lg-5">Wondering if there might be something more you and your money could do?</h2>
