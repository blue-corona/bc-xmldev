      ...
      <div class="container">
          <div class="row no-gutters">
              <div class="col-lg-10 px-lg-4 offset-lg-1 text-center">
                  <h2 class="position-relative bc_text_36 bc_line_height_36 mt-5 bc_font_default bc_text_thin text-white bottom_line1 d-block px-xl-0 px-lg-5 mx-xl-4 mx-lg-5 bc_sm_text_32 bc_sm_line_height_32">Wondering if there might be something more you and your money could do?</h2>
