...
class BC_Footer_Menuone_widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) { 
        ...
        echo '<div class="col-lg-3 col-md-6 d-none d-md-block pl-lg-5 mt-5 mt-md-0">';
        if ( $title ) {
        ...
        <?php foreach ($menu_items as $key => $value) {?>
                <a class="no_hover_underline d-block bc_text_16 bc_line_height_30 bc_font_alt_1 bc_text_light bc_color_primary bc_color_secondary_hover mt-3 <?php echo implode(" ",$value->classes);?>" target="<?php echo $value->target ?>" href="<?php echo $value->url;?>">
