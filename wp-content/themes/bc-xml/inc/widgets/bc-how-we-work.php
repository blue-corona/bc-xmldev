...
<div class="how_we_work position-relative overflow-hdden bc_color_lightgray_bg text-center px-4 pt-5 pb-4 pb-5 mt-5 mt-md-0">
<span></span>
	<?php 
	...
	<a href="<?php echo get_home_url();?>/resources/" class="btn_primary bc_line_height_26 py-2 px-3 mt-4">learn More</a>
</div>
