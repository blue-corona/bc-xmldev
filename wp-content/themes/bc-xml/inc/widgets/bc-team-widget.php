...
class BC_teams_Widget extends WP_Widget {
	...
	<!-- </h3> -->
        ...
        <?php 
			$teams_args  = array( 'post_type' => 'bc_teams', 'posts_per_page' => 6, 'order'=> 'ASC','orderby' => 'teams_title','post_status'  => 'publish');
        ...
        <div class="swiper-slide text-center p-4">
            <div class="image position-relative d-inline-block mx-auto p-3 sidebar_image_border">
             ...
             <span class="position-relative  bc_color_primary bc_text_24 bc_line_height_50 bc_font_alt_1 bc_text_bold d-block"><?php the_title();?><sup>®</sup> </span>
